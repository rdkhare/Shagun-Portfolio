...
const socialLinks = [
  {
    name: "GitHub",
    href: "https://github.com/shagunkhare",
    icon: (
      ...
      <div className="container mx-auto max-w-6xl px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="space-y-4">
            <h3 className="font-display text-lg font-light">S. Khare</h3>
            <p className="text-sm text-muted-foreground leading-relaxed serif">
              ...
              Independent reporting and thoughtful commentary.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p className="text-xs text-muted-foreground">
              For press inquiries or story tips
            </p>
          </div>
        </div>
        ...
        <div className="border-t border-border pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-xs text-muted-foreground">
              © {currentYear} Shagun Khare. All articles and content reflect independent journalism.
            </p>
            <p className="text-xs text-muted-foreground">
              Built with editorial integrity in mind.
            </p>
          </div>
        </div>
      </div>
